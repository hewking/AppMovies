...
// export default function NoticeBar({ title, style }: NoticeBarProps) {
//   return <View></View>;
// }
  ...
  _startAnimation = () => {
    ...
    Animated.sequence([
      ...
      Animated.timing(this.state.translateValue, {
        ...
        duration: this.state.duration, // 动画持续的时间（单位是毫秒），默认为 500
        easing: easingWay,
      }),
    ]).start(() => {
      // 无缝切换
