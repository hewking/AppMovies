...
import { Alert, Dimensions, FlatList, Image, Platform, StyleSheet, Text, TouchableOpacity, View, CameraRoll } from 'react-native';
...
interface Props {
  ...
  maxSizeChooseAlert: (size: number) => string;
}
...
export default class AlbumPickerView extends React.PureComponent<Props, State> {
  ...
  private fetchData = () => {
    CameraRoll.getPhotos({
      ...
      const imageList = result.edges.map((item, index) => {
