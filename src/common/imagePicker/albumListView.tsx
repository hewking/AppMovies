...
import {
  CameraRoll, Image, FlatList, Platform, StyleSheet,
  Text, TouchableOpacity, View, Dimensions
} from 'react-native';
import NaviBar, { getSafeAreaInset } from 'react-native-pure-navigation-bar';
import PageKeys from './pageKeys';

export default class AlbumListView extends React.PureComponent<any, any> {
  static defaultProps = {
    maxSize: 9,
  ...
  private renderItem = ({ item }) => {
    ...
    return (
      <TouchableOpacity onPress={this.clickRow.bind(this, item)}>
